...
<!--        <el-col :span="24">-->
<!--          <CardList title="高级搜索" type="keyvalue" :show-header="true">-->
<!--            <template #btn>-->
<!--              <el-button-group>-->
<!--                <el-button icon="el-icon-search" size="small" @click="submit"-->
<!--                  >搜索</el-button-->
<!--                >-->
<!--              </el-button-group>-->
<!--            </template>-->
...
<!--              >-->
<!--                <el-row :gutter="15">-->
<!--                  <CardListItem width="100px" prop="name">-->
...
<!--                    /></template>-->
<!--                  </CardListItem>-->
<!--                  <CardListItem width="100px" prop="address">-->
...
<!--                    /></template>-->
<!--                  </CardListItem>-->
<!--                  <CardListItem width="100px" prop="tag">-->
...
<!--// 键值对样式，及表单校验-->
<!--const search = (table:any<IRenderTableList>, form: ISearchForm) => {-->
...
<!--  table: any<IRenderTableList>,-->
<!--  form: ISearchForm,-->
<!--) => {-->
<!--  const d = await getTableList({-->
<!--    page: table.page,-->
<!--    size: table.size,-->
<!--    tag: form.tag,-->
<!--  })-->
...
<!--    (table.size = v) && renderTableList(table, form)-->
<!--  const handleCurrentChange = (v: number) =>-->
<!--    (table.page = v) && renderTableList(table, form)-->
<!--  const indexMethod = (index: number) =>-->
<!--    (table.page - 1) * table.size + index + 1-->
